...
<body>
	...
	if (isset($_POST['update'])) {
		...
		$query = "UPDATE logistica set cantidad = '$cantidad',producto = '$producto' WHERE id = $id ";
		mysqli_query($conn, $query);
		$_SESSION['message'] = 'producto guardado satisfactoriamente';
		$_SESSION['message_type'] = 'info';
		header("Location: consultastock.php");
	}
	?>
		...
		<div class="row">
			<div class="col-md-4 mx-auto">
				<div class="card card-body card text-dark">
					<form action="edit_ventas_stock.php?id=<?php echo $_GET["id"]; ?>" method="POST">
